#Library Setup
set search_path "$search_path ../rtl/ME_AB2 ../scripts /home/student/Desktop/Workspace/55nm ../work ../mem/asdrlspkb1p64x16cm2sw0/tt1p2v25c ../mem"
set target_library   "hu55npkldut_tt1p0v25c.db HL55LPGP3VDS_SL_A01_P2_TT1D8V1D2V25C.db sadslspkb1p24x64m4b1w0cp0d0t0_lib.db"
...
###YBR
write -format verilog -hier -out ../outputs/ME_chip_clk_with_driving.v
write -format ddc -hier -out ../outputs/ME_chip_clk_with_driving.ddc
